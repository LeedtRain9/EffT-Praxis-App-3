const questions = {
 ...
 "Kreuzschaltung": [
        ...
        { 
            ...
            answers: ["mitte", "rechts", "links"], 
            correct: [1] 
        },

        { 
            type: "textWithImage", 
            question: 'Wie viele Schaltstellen liegen bei einer Kreuzschaltung mindestens vor?', 
            image: "Bilder Querbeet/bild5.jpg",
            answers: ["3", "1", "2"], correct: [0] 
        },


        { 
            type: "textWithImage", 
            question: 'Welche Aussage zur Kreuzschaltung ist richtig?', 
            image: "Bilder Querbeet/bild5.jpg",
            answers: ["Mit einer Kreuzschaltung werden eine oder mehrer Lampen geschaltet", "Es werden eine oder mehrer Lampen unabhängig voneinander geschaltet", "Alle Schalterwippen müssen in der gleichen Position sein"], correct: [0] 
        },

        { 
            type: "textWithImage", 
            question: "Welches Funktion stellt der Schalter rechts dar?", 
            image: "Bilder Elektroinstallation/bild29.jpg", 
            answers: ["Kreuzschalter", "Wechselschalter", "Serienschalter"], correct: [0] 
        },

        {
            type: "textWithImage", 
            question: "Welcher Schalter stellt einen Kreuzschalter dar?",
            image: "Bilder Elektroinstallation/bild28.jpg",
            answers: ["Bild rechts", "Bild links"], correct: [0]
        },
                     
        { 
            type: "textWithImage", 
            question: "Welches Symbol gilt für Ausschalter?", 
            image: "Bilder Elektroinstallation/bild18_20.jpg", 
            answers: ["Symbol 1", "Symbol 2", "Symbol 3"], correct: [1] 
        },

        {
            type: "textWithImage", 
            question: "Was passiert, wenn die gelb- und grünmarkierten Leiter vertauscht werden?",
            image: "Bilder Elektroinstallation/bild40.jpg", 
            answers: ["Das Licht bleibt aus", "Nichts, die Funktion bleibt erhalten", "Es liegen zwei Aus-Wechselschaltungen in Reihe"], correct: [1] 
        },
        ...
        { 
            ...
            image: "Bilder Querbeet/bild5.jpg",
            answers: ["Man benötigt 2 Kreuzschalter und 3 Wechselschalter.", "Es sind 4 Wechselschalter und 1 Kreuzschalter.", "Man benötigt 3 Kreuzschalter und 2 Wechselschalter"], correct: [2] 
        },

        {
            type: "textWithImage", 
            question: "Im vorliegenden Fall wurde der gelb- mit dem grün markierten Leiter vertauscht. Mit welcher Auswirkuung ist zu rechnen?",
            image: "Bilder Elektroinstallation/bild41.jpg", 
            answers: ["Dauerlicht", "Es liegt eine Wechselschaltung vor, die mit dem Schalter ein- und ausgeschaltet werden kann", "Die Lampe leuchtet überhaupt nicht"], correct: [1] 
        },
        ...
        { 
            ...
            image: "Bilder Querbeet/bild5.jpg", 
            answers: ["Die Korrespondenzleitungen wurden diagonal vertauscht", "Die Sicherung ist durchgebrannt", "Der Schalter ist defekt"], correct: [1, 2] 
        },
...
function displayOverallScore() {
    ...
    if (medal === 'Platin') {
        const platinSound = new Audio('Moskau im Regen.mp3');
